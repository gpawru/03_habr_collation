...
// веса L1 у чамо хангыль идут последовательно, L1 располагается в младших 16 битах u32-весов,
// следовательно, мы можем просто вычислить все веса, не полагаясь на данные из таблицы
